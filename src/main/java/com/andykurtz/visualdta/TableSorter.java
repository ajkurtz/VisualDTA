...
/**
 * TableSorter is a decorator for TableModels; adding sorting functionality to
 * a supplied TableModel. TableSorter does not store or copy the data in its
 ...
 * ecorated with a renderer that indicates the sorting status of each column.
 * n addition, a mouse listener is installed with the following behavior:
 * <ul>
 ...
 *   the opposite order: {NOT_SORTED, DESCENDING, ASCENDING}.
 *   <li> CONTROL-mouse-click and CONTROL-SHIFT-mouse-click: as above except
 *   that the changes to the column do not cancel the statuses of columns that
...
public class TableSorter extends AbstractTableModel {
    ...
    public final static Comparator COMPARABLE_COMAPRATOR =
            new Comparator() {
                public int compare(Object o1, Object o2) {
                    return ((Comparable) o1).compareTo(o2);
                }
            };
    public final static Comparator LEXICAL_COMPARATOR =
            new Comparator() {
                public int compare(Object o1, Object o2) {
    ...
    private static class Arrow implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            //int dx = (int)(size / 2 * Math.pow(0.8, priority) + 2);
            int dx = (size / 2) + 1;
            dx = ((dx % 2) == 0) ? dx : dx + 1;
            int dy = descending ? dx : -dx;

            // Align icon (roughly) with font baseline.
            y = y + 5 * size / 6 + (descending ? -dy : 0) - 1;
    ...
    private class MouseHandler extends MouseAdapter {
        public void mouseClicked(MouseEvent e) {
            ...
            if (column != -1) {
                ...
                status = status + -1; // always cycle to descending first
